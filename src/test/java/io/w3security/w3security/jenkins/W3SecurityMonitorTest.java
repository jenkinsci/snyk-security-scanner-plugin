...
public class W3SecurityMonitorTest {
  ...
  public void before() throws IOException, InterruptedException {
    ...
    when(installationMock.getW3SecurityExecutable(any())).thenReturn("w3security");
  ...
  public void testMonitorShouldFailOnErrorIfConfigIsSet() throws IOException, InterruptedException {// mock setup
    ...
    W3SecurityContext context = W3SecurityContext.forFreestyleProject(buildMock, null, launchMock, taskListenerMock);
    ...
    try (MockedStatic<PluginMetadata> pluginMetadataMockedStatic = Mockito.mockStatic(PluginMetadata.class)) {
      ...
      W3SecurityMonitor.monitorProject(context, config, installationMock, "token");
